...
#         for i in custom_price_list:
#             dynamic_column_name = i.price_list
#             column = {"label": _(dynamic_column_name), "fieldname": dynamic_column_name.lower().replace(" ", "_"), "fieldtype": "Currency", "width": 100}
...
#     # return data
#     static_data = frappe.db.sql(sql, as_dict=True)

#     for item_data in static_data:
#         item_code = item_data['item_code']
#         pos_settings = frappe.get_single("POS Bahrain Settings")
#         custom_price_list = pos_settings.custom_price_list
#         if custom_price_list:
#             for price_list in custom_price_list:
#                 dynamic_price = frappe.get_value("Item Price", {"item_code": item_code, "price_list": price_list.price_list}, "price_list_rate")
#                 if dynamic_price:
#                     item_data[price_list.price_list.lower().replace(" ", "_")] = dynamic_price
