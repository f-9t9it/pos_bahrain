...
app_include_js = [
	...
	"assets/pos_bahrain/js/scripts/extensions/scan_barcode.js",
    "assets/pos_bahrain/node_modules/jsbarcode/dist/JsBarcode.all.min.js",
...
doc_events = {
    ...
    "Purchase Invoice": {
        ...
        "on_submit": [
			...
			"pos_bahrain.doc_events.purchase_invoice.before_submit",
        ]
    },
    "Payment Entry": {
...
override_whitelisted_methods = {
     "erpnext.stock.utils.scan_barcode": "pos_bahrain.api.item.search_serial_or_batch_or_barcode_number" 
